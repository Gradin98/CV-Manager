 ...
 * <p>
 * cand modul date si modul regex este bifat.
 * </p>
 * 
 * <ol>
 * Contine functiile:
 ...
 * 
 */
public class DateRegexSearch {

	/**
	 * 
	 * Functie care seteaza evenimentul pe butonul submitButton cand
	 * <p>
	 * modul regex si modul de data este activat
	 * </p>
	 * 
	 * @param searchfield
	...
	public static void functie(TextField searchfield, Pane pane, Button submitButton, DatePicker data1,
		...
		EventHandler<ActionEvent> submitNormalHandler = new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent arg0) {
				...
				final TreeMap<String, String> date = connection.contentByDate(
						transform.transform(searchfield.getText()), data1.getValue().toString(),
						data2.getValue().toString());
				int valueX = 20;
