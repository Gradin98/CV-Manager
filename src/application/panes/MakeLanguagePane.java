...
/**
 * Clasa care seteaza contentu pentru pagina de creeare fisier nou de Language
 * 
 * <ol>
 * Contine functiile:
 ...
 *
 */
public class MakeLanguagePane {

	private String style = "-fx-font: 16px \"Arial Bold\";" + "-fx-text-fill: #fff; "
			+ "-fx-background-color: transparent;";

	/**
	 * Functie care seteaza contentu pentru pagina de creare fisier de Language
	 * 
	 * @param scene
	 * @param box
	 */
	public void setContent(Scene scene) {
		...
		final TextField fieldName = makeTextField(130, 20);
